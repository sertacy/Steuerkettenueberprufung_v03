...
Public Class Form1
    ...
    'picturebuttons für Stationen 1 bis 4!
    ...
    Public myZeiger_Fehler_S1 As Short  'Fehlerglied position der Kette für s1 bis s4
    Public myZeiger_Fehler_S2 As Short
    Public myZeiger_Fehler_S3 As Short
    Public myZeiger_Fehler_S4 As Short          '(31byte)
    Public myFZ_Farbe As Short          'Anzahl der Fehler für jede Stoerung
    ...
    '****************************
    'Grafikbalken für Speicher 1 und 2
    ...
    Public hConnect() As Integer   'variablen handler array für notification events....
...
#Region " Vom Windows Form-Designer generierter Code "
    ...
    Private Sub InitializeComponent()
        ...
        Me.lblFlaechenSpStatus.Text = "Flächenspeicher"
        ...
        Me.btnNIOruecksetz.Text = "NIO Zähler zurücksetzen!"
        ...
        Me.btnIOruecksetz.Text = "Alle Zähler zurücksetzen!"
        ...
        Me.lbldruckfehler.Text = "Störung Druckluft!"
        ...
        Me.lblausschuss.Text = "Ausschuss-behälter"
        ...
        Me.lblAusschussBehVoll.Text = "Ausschussbehälter voll !"
        ...
        Me.lblAusschussBehFehlt.Text = "Ausschussbehälter fehlt !"
        ...
        Me.lblmyST_AnfDummyPruefung.Text = "Dummyprüfung durchführen!"
...
#End Region
    ...
    Private Sub btnStation1Farbe_Click(ByVal sender As Object, ByVal e As EventArgs) _
       Handles btnStation1Farbe.Click
        ...
        Else
            ...
            mydialog.lblmeldung.Text = "Nur im Handbetrieb möglich!"
    ...
    'Beispiel für connection auf main.
    'Try
    ...
    Public Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        dataStream = New AdsStream(4)  'Streamlaenge in Byte... hier müssen byte dazugerechnet werden bei verlaengerung...
    ...
    Private Sub LeseTimer_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LeseTimer.Tick
        ...
        If myFlaechenSp1_IO = True Then
            lblFlaechenSpStatus.Text = "Flächenspeicher 1 nicht bereit!"
        ...
        If myFlaechenSp2_IO = True Then
            lblFlaechenSpStatus.Text = "Flächenspeicher 2 nicht bereit!"
            lblFlaechenSpStatus.Visible = True
            'Else
            'lblFlaechenSpStatus.Visible = False
        End If
        ...
        If (myFlaechenSp1_IO = True And myFlaechenSp2_IO = True) Then
            lblFlaechenSpStatus.Text = "Flächenspeicher 1 und 2 nicht bereit!"
            lblFlaechenSpStatus.Visible = True
            'Else
            'lblFlaechenSpStatus.Visible = False
        End If
    ...
    Private Sub auswerten()
        ...
        ElseIf (myREF_IO = False) And (myREF_Enable = True) Then
            ...
            lblFehlerMain.Text = "Trennstelle positionieren und Kettenanfangstaste drücken!"
            lblFehlerMain.Visible = True
        ElseIf (myREF_IO = False) And (myREF_Enable = False) Then
            lblFehler.Text = "REFERENZFEHLER!!!"
            lblFehler.ForeColor = Color.Red
            lblFehlerMain.Text = "Kette weiter zurückfahren!"
            lblFehlerMain.Visible = True
        ...
        'stoerunganlage boolean array checken und status setzen bzw verändern...
        ...
        If myStoerunganlage_arr(1) = True Then  'Wenn NotAus ausgeloest
            ...
            lblFehler.ForeColor = Color.Red
            lblFehlerMain.Text = "Not-Aus wurde ausgelöst!"
            lblFehlerMain.Visible = True
        End If
        ...
        If myStoerunganlage_arr(7) = True Then 'wenn Kupplung Motor 2
            ...
            lblFehler.ForeColor = Color.Red
            lblFehlerMain.Text = "Störung Kupplung Motor 2"
            lblFehlerMain.Visible = True
        Else
        ...
        If myStoerunganlage_arr(8) = True Then 'wenn Kupplung Motor 1
            ...
            lblFehler.ForeColor = Color.Red
            lblFehlerMain.Text = "Störung Kupplung Motor 1"
            lblFehlerMain.Visible = True
        Else
        ...
        If myStoerunganlage_arr(10) = True Then   ' wenn druckluft aus...
            lbldruckfehler.Text = "Störung Druckluft!"
        ...
        '********************************************************************************************
        '********************************************************************************************
        '*********Fehlerspeicher1 bit ueberpruefung für die Stationen 1 bis 4  **********************
        'Farbsensorfehler Station 1 *****************************************************************
        If myFehlerspeicher1_arr(0) = True Then
            If (myS2_Vor_1) Then
                If (myDummy = True) Then
                    Dim f As New CFehlerschreiber("Farblaschenfehler Station 1 (Dummyprüfung)") 'schreibe in kettenfehler.txt
                    f = Nothing
                Else
        ...
        If myFehlerspeicher1_arr(1) = True Then
            If (myS2_Vor_1) Then
                If (myDummy = True) Then
                    Dim f As New CFehlerschreiber("Laschenabstandfehler (Kettenhoehe) Station 2 (Dummyprüfung)") 'schreibe in kettenfehler.txt
                    f = Nothing
                Else
        ...
        If myFehlerspeicher1_arr(2) = True Then
            If (myS2_Vor_1) Then
                If (myDummy = True) Then
                    Dim f As New CFehlerschreiber("Bolzenhoehenfehler Station 2 (Dummyprüfung)") 'schreibe in kettenfehler.txt
                    f = Nothing
                Else
        ...
        'Bei mehreren fehlern muss noch überprüft werden ob gesamtfehler existiert für jeweilige station,
        ...
        'Distanzfehler Höhe Station 3 *********************************
        If myFehlerspeicher1_arr(3) = True Then
            If (myS2_Vor_1) Then
                If (myDummy = True) Then
                    Dim f As New CFehlerschreiber("Distanzfehler (Kettenhoehe) Station 3 (Dummyprüfung)") 'schreibe in kettenfehler.txt
                    f = Nothing
                Else
        ...
        If myFehlerspeicher2_arr(1) = True Then
            If (myS2_Vor_1) Then
                If (myDummy = True) Then
                    Dim f As New CFehlerschreiber("Kamera Fehler AL Oben Station 4 (Dummyprüfung)") 'schreibe in kettenfehler.txt
                    f = Nothing
                Else
        ...
        If myFehlerspeicher2_arr(2) = True Then
            If (myS2_Vor_1) Then
                If (myDummy = True) Then
                    Dim f As New CFehlerschreiber("Kamera Fehler AL Unten Station 4 (Dummyprüfung)") 'schreibe in kettenfehler.txt
                    f = Nothing
                Else
        ...
        If myFehlerspeicher2_arr(3) = True Then
            If (myS2_Vor_1) Then
                If (myDummy = True) Then
                    Dim f As New CFehlerschreiber("Kamera Fehler IL Oben Station 4 (Dummyprüfung)") 'schreibe in kettenfehler.txt
                    f = Nothing
                Else
        ...
        If myFehlerspeicher2_arr(4) = True Then
            If (myS2_Vor_1) Then
                If (myDummy = True) Then
                    Dim f As New CFehlerschreiber("Kamera Fehler IL Unten Station 4 (Dummyprüfung)") 'schreibe in kettenfehler.txt
                    f = Nothing
                Else
        ...
        If myFehlerspeicher2_arr(5) = True Then
            If (myS2_Vor_1) Then
                If (myDummy = True) Then
                    Dim f As New CFehlerschreiber("Kamera Fehler Rolle Links Station 4 (Dummyprüfung)") 'schreibe in kettenfehler.txt
                    f = Nothing
                Else
        ...
        If myFehlerspeicher2_arr(6) = True Then
            If (myS2_Vor_1) Then
                If (myDummy = True) Then
                    Dim f As New CFehlerschreiber("Kamera Fehler Rolle Rechts Station 4 (Dummyprüfung)") 'schreibe in kettenfehler.txt
                    f = Nothing
                Else
        ...
        '***********************************************************************
        '*********  Fehlerspeicher1 für stationen 1 bis 4 ENDE   ***************        

        '***********************************************************************
        '***********  Kontrolle_Aktiv bit ueberpruefung für die Stationen 1 bis 4  *********************
        'Kontrolle_Aktiv uberprüfung Station 1 *********************************
        ...
        '************************************************************
        '************************************************************
        'Kontrolle_Aktiv uberprüfung Station 2 *********************************
        ...
        '************************************************************
        '************************************************************
        'Kontrolle_Aktiv uberprüfung Station 3 *********************************
        ...
        '************************************************************
        '************************************************************
        'Kontrolle_Aktiv uberprüfung Station 4 *********************************
        ...
        '******* Uberpruefung bei fehlern, rückfahrt 1 2 und anfang und ende trennen **************
        '******* Normalbetrieb:
    ...
    Private Sub btnKettentypen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnKettentypen.Click
        ...
        Else
            ...
            'mydialog.BringToFront()
            'mydialog.Show()
            'MsgBox("Nur im Handbetrieb möglich!")
        End If
    End Sub
    ...
    Private Sub btnIOruecksetz_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnIOruecksetz.Click
        ...
        Catch err As Exception
            MessageBox.Show(err.Message & "---" & "Zähler konnten nicht genullt werden")
        End Try
        vh_0 = Nothing
        vh_1 = Nothing
        vh_2 = Nothing
    ...
    Public Sub leseVerzeichnis()
        Try
            ...
            myFiles = Nothing
        Catch err As Exception
            MsgBox("Keine Ketten-Artikel Datei vorhanden! Bitte zuerst eine Artikelnummer über Auftragverwaltung anlegen!")
        End Try
    End Sub
    ...
    Public Sub ListBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles listboxArtikelnr.SelectedIndexChanged
        ...
        artikelno = artikel & ".art"   'fuege die dateiendung .art ein für dateisuche
        ...
        If ((myH_Hand = False) And (myH_KettenAnfang = False) And (myDummy_NIO = True)) Then
            ...
            mydialog.lblmeldung3.Text = "Dummyprüfung erfolglos! Segment verständigen!"
        ...
        ElseIf (myDummy_NIO = True) Then
            mydialog = New FDialog
            mydialog.lblmeldung.Text = "Dummyprüfung erfolglos!"
            mydialog.lblmeldung.ForeColor = Color.Black
            mydialog.lblmeldung2.Text = "Segment verständigen!"
            mydialog.lblmeldung2.ForeColor = Color.Black
            mydialog.lblmeldung2.Visible = True
    ...
    Public Sub kettentypwechseln()
        ...
        If File.Exists(artikelno) = True Then
            ...
            Dim stringstream As New AdsStream(20) 'für bezeichnerstring
    ...
    '    Catch err As Exception
    '        MessageBox.Show(err.Message & "---" & "Ausschussbehälter Klappe konnte nicht geschlossen werden!")
    '    End Try
    '    vh = Nothing
    '    _bool = Nothing
    ...
    Public Sub behaelteroeffnen()
        ...
        Try
            ...
            adsClient.DeleteVariableHandle(vh)
        Catch err As Exception
            MessageBox.Show(err.Message & "---" & "Ausschussbehälter Klappe konnte nicht geöffnet werden!")
        End Try
        vh = Nothing
        _bool = Nothing
    End Sub
